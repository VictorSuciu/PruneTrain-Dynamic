...
""" 
All unique layers of MobileNet for ImageNet
"""
k3_s2_p1 = [4, 8, 12, 24]
...
arch[55] = {'name':'relu'}
arch[56] = {'name':'fc', 'out_chs':1000}

"""
Generate dense VGG11_BN architecture
- Only input/output channel number change
"""
def _genDenseArchMobileNet_01(model, out_f_dir, arch_name, dense_chs, chs_map=None):

  # File heading
  ctx = 'import torch.nn as nn\n'
  ctx += '__all__ = [\'mobilenet_01\']\n'
  ...
  f_out1 = open(os.path.join('/work/03883/erhoo/projects/spar/sparse_train_pytorch/src/models/imagenet', 'mobilenet_01.py'),'w')
  f_out1.write(ctx)
