...
"""
def _genDenseArchResNet50_03(model, out_f_dir, arch_name, dense_chs, chs_map, is_gating=False):
  # File heading
  ctx = 'import torch.nn as nn\n'
  ctx += 'import torch\n'
  ctx += '__all__ = [\'resnet50_flat_03\']\n'
  ...
  # ResNet50 definition
  ctx += 'def resnet50_flat_03(**kwargs):\n'
  ...
  f_out1 = open(os.path.join('/work/03883/erhoo/projects/spar/sparse_train_pytorch/src/models/imagenet', 'resnet50_flat_03.py'),'w')
  f_out1.write(ctx)
