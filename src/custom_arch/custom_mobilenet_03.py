...
"""
def _genDenseArchMobileNet_03(model, out_f_dir, arch_name, dense_chs, chs_map=None):

  # File heading
  ctx = 'import torch.nn as nn\n'
  ctx += '__all__ = [\'mobilenet_03\']\n'
  ...
  f_out1 = open(os.path.join('/work/03883/erhoo/projects/spar/sparse_train_pytorch/src/models/imagenet', 'mobilenet_03.py'),'w')
  f_out1.write(ctx)
