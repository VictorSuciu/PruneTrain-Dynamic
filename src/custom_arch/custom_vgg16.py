...
arch[1] = {'name':'conv2' , 'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[2] = {'name':'conv3' ,  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[3] = {'name':'conv4' ,  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[4] = {'name':'conv5' ,  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[5] = {'name':'conv6' ,  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[6] = {'name':'conv7' ,  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[7] = {'name':'conv8' ,  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[8] = {'name':'conv9' ,  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[9] = {'name':'conv10',  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[10] = {'name':'conv11',  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[11] = {'name':'conv12',  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
arch[12] = {'name':'conv13',  'kernel_size':3, 'stride':1, 'padding':1, 'bias':False}
