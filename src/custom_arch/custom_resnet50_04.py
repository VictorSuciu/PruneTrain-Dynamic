...
"""
def _genDenseArchResNet50_04(model, out_f_dir, arch_name, dense_chs, chs_map, is_gating=False):
  # File heading
  ctx = 'import torch.nn as nn\n'
  ctx += 'import torch\n'
  ctx += '__all__ = [\'resnet50_flat_04\']\n'
  ...
  # ResNet50 definition
  ctx += 'def resnet50_flat_04(**kwargs):\n'
  ...
  f_out1 = open(os.path.join('/work/03883/erhoo/projects/spar/sparse_train_pytorch/models/imagenet', 'resnet50_flat_04.py'),'w')
  f_out1.write(ctx)
